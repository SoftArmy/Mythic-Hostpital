...
Config.ReviveReward               = 200000  -- revive reward, set to 0 if you don't want it enabled
...
Config.RespawnPoint = { coords = vector3(-48.05, -1844.66, 26.24), heading = 55.03 }
...
Config.Hospitals = {
	...
	CentralLosSantos = {
		...
		Blip = {
			coords = vector3(307.85, -588.77, 43.28),
			sprite = 61,
			scale  = 1.2,
			color  = 2
		},
		...
		AmbulanceActions = {
			vector3(301.5465, -599.5030, 42)
		},

		Pharmacies = {
			vector3(309.6469, -561.4781, 42)
		},
